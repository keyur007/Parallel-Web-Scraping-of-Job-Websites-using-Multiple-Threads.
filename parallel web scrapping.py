...
#Passing of various ARGUMENTS#

input_job = "computer science"
input_quote = False # add quotation marks("") to your input_job
input_city = "Chennai" # leave empty if input_city is not specified
input_state = "Tamil Nadu"
sign = "+"
BASE_URL_indeed = 'http://www.indeed.co.in'
...
path = 'D:\ACAD\Project\PDC parallel scrappping\indeed'+ '.csv'
